...
//		blackboard = new CoherenceBlackboard();
		...
		cachingModelArea = blackboard.createArea("processorSpace_caching", Policy.NEVER_LOCK);
		auxiliaryAreas = new LinkedList<IArea>();
		ids4RuleWNoInputElem = blackboard.createArea("ids2RuleWNoInputElem", Policy.NEVER_LOCK); initializeAreaIds4RuleWNoInputElem(ids4RuleWNoInputElem);
	}
	
	public void createTrgArea(String areaName) throws BlackboardException {
