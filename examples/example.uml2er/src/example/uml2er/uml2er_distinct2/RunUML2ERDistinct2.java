...
public class RunUML2ERDistinct2 {
	...
	public RunUML2ERDistinct2 setIN(String inXmiPath, String inmmPath) {
		this.inXmiPath = inXmiPath;
		this.inmmPath = inmmPath;
		return this;
	}

	public RunUML2ERDistinct2 setOUT(String outXmiPath, String outmmPath) {
		this.outXmiPath = outXmiPath;
		this.outmmPath = outmmPath;
		return this;
	}
	
	public RunUML2ERDistinct2 run() throws Exception {
		...
		double time = mtLauncher.launch(
				new UML2ERDistinct2(mtLauncher.getSrcAreas().get(0), mtLauncher.getTrgArea(), mtLauncher.getCachingArea()),
