...
@SuppressWarnings("serial")public  class VariableDeclarationFragment  implements Serializable, IdentifiableElement, IVariableDeclarationFragment, javamm.IVariableDeclaration { 
String id, trgId, modelName_;
public String getId() { 	return id;} public void setId(String id) {	this.id = id;}public String getTrgId() {	return trgId;}public void setTrgId(String trgId) {	this.trgId = trgId;}public String getModelName() {	return modelName_;}public void setModelName(String modelName) {	this.modelName_ = modelName;}@Override public Object clone() throws CloneNotSupportedException { return super.clone(); }public String getTypeId() { return "VariableDeclarationFragment"; }
public VariableDeclarationFragment() { }public VariableDeclarationFragment(String id_,String[] comments, String originalCompilationUnit, String originalClassFile, java.lang.String name, boolean proxy, String[] usagesInImports, int extraArrayDimensions, String initializer, String[] usageInVariableAccess, String variablesContainer){
setId(id_);
...
String s = "VariableDeclarationFragment_"+this.id;s+=" comments="+ java.util.Arrays.toString(comments);s+=" originalCompilationUnit="+originalCompilationUnit;s+=" originalClassFile="+originalClassFile;s+=" name="+name;s+=" proxy="+proxy;s+=" usagesInImports="+ java.util.Arrays.toString(usagesInImports);s+=" extraArrayDimensions="+extraArrayDimensions;s+=" initializer="+initializer;s+=" usageInVariableAccess="+ java.util.Arrays.toString(usageInVariableAccess);s+=" variablesContainer="+variablesContainer;return s;}}