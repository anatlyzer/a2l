...
@SuppressWarnings("serial")public  class LabeledStatement  implements Serializable, IdentifiableElement, ILabeledStatement, javamm.INamedElement, javamm.IStatement { 
String id, trgId, modelName_;
public String getId() { 	return id;} public void setId(String id) {	this.id = id;}public String getTrgId() {	return trgId;}public void setTrgId(String trgId) {	this.trgId = trgId;}public String getModelName() {	return modelName_;}public void setModelName(String modelName) {	this.modelName_ = modelName;}@Override public Object clone() throws CloneNotSupportedException { return super.clone(); }public String getTypeId() { return "LabeledStatement"; }
public LabeledStatement() { }public LabeledStatement(String id_,String[] comments, String originalCompilationUnit, String originalClassFile, java.lang.String name, boolean proxy, String[] usagesInImports, String body, String[] usagesInBreakStatements, String[] usagesInContinueStatements){
setId(id_);
...
String s = "LabeledStatement_"+this.id;s+=" comments="+ java.util.Arrays.toString(comments);s+=" originalCompilationUnit="+originalCompilationUnit;s+=" originalClassFile="+originalClassFile;s+=" name="+name;s+=" proxy="+proxy;s+=" usagesInImports="+ java.util.Arrays.toString(usagesInImports);s+=" body="+body;s+=" usagesInBreakStatements="+ java.util.Arrays.toString(usagesInBreakStatements);s+=" usagesInContinueStatements="+ java.util.Arrays.toString(usagesInContinueStatements);return s;}}