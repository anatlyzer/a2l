...
@SuppressWarnings("serial")public  class SingleVariableDeclaration  implements Serializable, IdentifiableElement, ISingleVariableDeclaration, javamm.IVariableDeclaration { 
String id, trgId, modelName_;
public String getId() { 	return id;} public void setId(String id) {	this.id = id;}public String getTrgId() {	return trgId;}public void setTrgId(String trgId) {	this.trgId = trgId;}public String getModelName() {	return modelName_;}public void setModelName(String modelName) {	this.modelName_ = modelName;}@Override public Object clone() throws CloneNotSupportedException { return super.clone(); }public String getTypeId() { return "SingleVariableDeclaration"; }
public SingleVariableDeclaration() { }public SingleVariableDeclaration(String id_,String[] comments, String originalCompilationUnit, String originalClassFile, java.lang.String name, boolean proxy, String[] usagesInImports, int extraArrayDimensions, String initializer, String[] usageInVariableAccess, String modifier, boolean varargs, String type, String[] annotations, String methodDeclaration, String catchClause, String enhancedForStatement){
setId(id_);
