...
@SuppressWarnings("serial")public  class UnresolvedEnumDeclaration  implements Serializable, IdentifiableElement, IUnresolvedEnumDeclaration, javamm.IEnumDeclaration, javamm.IUnresolvedItem { 
String id, trgId, modelName_;
public String getId() { 	return id;} public void setId(String id) {	this.id = id;}public String getTrgId() {	return trgId;}public void setTrgId(String trgId) {	this.trgId = trgId;}public String getModelName() {	return modelName_;}public void setModelName(String modelName) {	this.modelName_ = modelName;}@Override public Object clone() throws CloneNotSupportedException { return super.clone(); }public String getTypeId() { return "UnresolvedEnumDeclaration"; }
public UnresolvedEnumDeclaration() { }public UnresolvedEnumDeclaration(String id_,String[] comments, String originalCompilationUnit, String originalClassFile, java.lang.String name, boolean proxy, String[] usagesInImports, String abstractTypeDeclaration, String[] annotations, String anonymousClassDeclarationOwner, String modifier, String[] usagesInTypeAccess, String[] bodyDeclarations, String[] commentsBeforeBody, String[] commentsAfterBody, String package_, String[] superInterfaces, String[] enumConstants){
setId(id_);
