...
@SuppressWarnings("serial")public  class UnresolvedTypeDeclaration  implements Serializable, IdentifiableElement, IUnresolvedTypeDeclaration, javamm.IAbstractTypeDeclaration, javamm.IUnresolvedItem { 
String id, trgId, modelName_;
public String getId() { 	return id;} public void setId(String id) {	this.id = id;}public String getTrgId() {	return trgId;}public void setTrgId(String trgId) {	this.trgId = trgId;}public String getModelName() {	return modelName_;}public void setModelName(String modelName) {	this.modelName_ = modelName;}@Override public Object clone() throws CloneNotSupportedException { return super.clone(); }public String getTypeId() { return "UnresolvedTypeDeclaration"; }
