...
@SuppressWarnings("serial")public  class UnresolvedClassDeclaration  implements Serializable, IdentifiableElement, IUnresolvedClassDeclaration, javamm.IClassDeclaration, javamm.IUnresolvedItem { 
String id, trgId, modelName_;
public String getId() { 	return id;} public void setId(String id) {	this.id = id;}public String getTrgId() {	return trgId;}public void setTrgId(String trgId) {	this.trgId = trgId;}public String getModelName() {	return modelName_;}public void setModelName(String modelName) {	this.modelName_ = modelName;}@Override public Object clone() throws CloneNotSupportedException { return super.clone(); }public String getTypeId() { return "UnresolvedClassDeclaration"; }
public UnresolvedClassDeclaration() { }public UnresolvedClassDeclaration(String id_,String[] comments, String originalCompilationUnit, String originalClassFile, java.lang.String name, boolean proxy, String[] usagesInImports, String abstractTypeDeclaration, String[] annotations, String anonymousClassDeclarationOwner, String modifier, String[] usagesInTypeAccess, String[] bodyDeclarations, String[] commentsBeforeBody, String[] commentsAfterBody, String package_, String[] superInterfaces, String[] typeParameters, String superClass){
setId(id_);
