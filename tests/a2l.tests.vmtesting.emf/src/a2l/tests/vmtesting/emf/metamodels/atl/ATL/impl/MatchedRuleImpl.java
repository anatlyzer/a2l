 ...
 * </p>
 * <ul>
 *   <li>{@link a2l.tests.vmtesting.emf.metamodels.atl.ATL.impl.MatchedRuleImpl#getInPattern <em>In Pattern</em>}</li>
 *   <li>{@link a2l.tests.vmtesting.emf.metamodels.atl.ATL.impl.MatchedRuleImpl#getChildren <em>Children</em>}</li>
 *   <li>{@link a2l.tests.vmtesting.emf.metamodels.atl.ATL.impl.MatchedRuleImpl#getSuperRule <em>Super Rule</em>}</li>
 *   <li>{@link a2l.tests.vmtesting.emf.metamodels.atl.ATL.impl.MatchedRuleImpl#isIsAbstract <em>Is Abstract</em>}</li>
 *   <li>{@link a2l.tests.vmtesting.emf.metamodels.atl.ATL.impl.MatchedRuleImpl#isIsRefining <em>Is Refining</em>}</li>
 *   <li>{@link a2l.tests.vmtesting.emf.metamodels.atl.ATL.impl.MatchedRuleImpl#isIsNoDefault <em>Is No Default</em>}</li>
 * </ul>
 *
 * @generated
 */
