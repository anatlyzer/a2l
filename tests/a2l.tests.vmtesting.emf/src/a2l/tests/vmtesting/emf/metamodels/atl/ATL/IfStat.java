 ...
 * </p>
 * <ul>
 *   <li>{@link a2l.tests.vmtesting.emf.metamodels.atl.ATL.IfStat#getCondition <em>Condition</em>}</li>
 *   <li>{@link a2l.tests.vmtesting.emf.metamodels.atl.ATL.IfStat#getThenStatements <em>Then Statements</em>}</li>
 *   <li>{@link a2l.tests.vmtesting.emf.metamodels.atl.ATL.IfStat#getElseStatements <em>Else Statements</em>}</li>
 * </ul>
 *
 * @see a2l.tests.vmtesting.emf.metamodels.atl.ATL.ATLPackage#getIfStat()
 * @model
 * @generated
 */
public interface IfStat extends Statement {
	 ...
	 * @see a2l.tests.vmtesting.emf.metamodels.atl.ATL.ATLPackage#getIfStat_Condition()
	...
	/**
	 * Sets the value of the '{@link a2l.tests.vmtesting.emf.metamodels.atl.ATL.IfStat#getCondition <em>Condition</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see a2l.tests.vmtesting.emf.metamodels.atl.ATL.ATLPackage#getIfStat_ThenStatements()
	 ...
	 * @see a2l.tests.vmtesting.emf.metamodels.atl.ATL.ATLPackage#getIfStat_ElseStatements()
	 * @model containment="true"
	 * @generated
	 */
