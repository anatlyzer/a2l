 ...
 * </p>
 * <ul>
 *   <li>{@link dblp.AuthorInfo.impl.JournalImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class JournalImpl extends MinimalEObjectImpl.Container implements Journal {
	...
	protected EClass eStaticClass() {
		return AuthorInfoPackage.Literals.JOURNAL;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AuthorInfoPackage.JOURNAL__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AuthorInfoPackage.JOURNAL__NAME:
				return getName();
		}
