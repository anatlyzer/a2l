 ...
 * </p>
 * <ul>
 *   <li>{@link dblp.AuthorInfo.impl.ConferenceImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConferenceImpl extends MinimalEObjectImpl.Container implements Conference {
	...
	protected EClass eStaticClass() {
		return AuthorInfoPackage.Literals.CONFERENCE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AuthorInfoPackage.CONFERENCE__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AuthorInfoPackage.CONFERENCE__NAME:
				return getName();
		}
