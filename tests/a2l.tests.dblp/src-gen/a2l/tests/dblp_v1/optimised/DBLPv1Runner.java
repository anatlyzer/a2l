...
a2l.tests.dblp_v1.optimised.DBLPv1 trafo0;if ( this.stats == null ) this.stats = IStatsRecorder.NULL_RECORDER;;
	...
	this.inputExtent = new InputExtent(); this.globalContext = new a2l.tests.dblp_v1.optimised.DBLPv1GlobalContext();this.INModel = this.INDataSource.createModel(this.globalContext::addAllInstancesObject);inputExtent.addAll(this.INModel.allInstances());;
