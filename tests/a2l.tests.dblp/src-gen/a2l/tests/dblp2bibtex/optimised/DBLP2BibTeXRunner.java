...
import a2l.tests.dblp2bibtex.optimised.DBLP2BibTeXGlobalContext;
...
public a2l.tests.dblp2bibtex.optimised.DBLP2BibTeXRunner setNumThreads(int n){
numThreads = n;

	return this;
}
	public a2l.tests.dblp2bibtex.optimised.DBLP2BibTeXRunner setFootprint(IFootprint n){
footprint = n;

	return this;
}
	public a2l.tests.dblp2bibtex.optimised.DBLP2BibTeXRunner setStatsRecorder(IStatsRecorder n){
stats = n;

	return this;
}
	public a2l.tests.dblp2bibtex.optimised.DBLP2BibTeXRunner doImmediateWrite(boolean n){
immediateWrite = n;

	return this;
}
	public a2l.tests.dblp2bibtex.optimised.DBLP2BibTeXRunner setIN(org.eclipse.emf.ecore.resource.Resource modelINresource){
INDataSource = new lintra.emf.EMFDataSource(modelINresource, footprint);

	return this;
}
	public a2l.tests.dblp2bibtex.optimised.DBLP2BibTeXRunner setIN(java.lang.String modelINxmiFile, java.lang.String mmDBLPxmiFile){
lintra.emf.LintraEMFUtils.ModelMetamodelPair m = lintra.emf.LintraEMFUtils.readModel(modelINxmiFile, mmDBLPxmiFile);return setIN(m.getModel());
	...
	public a2l.tests.dblp2bibtex.optimised.DBLP2BibTeXRunner setOUT(org.eclipse.emf.ecore.resource.Resource modelOUTResource, org.eclipse.emf.ecore.resource.Resource mmBTResource){
OUTModelResource = modelOUTResource;
	...
	public a2l.tests.dblp2bibtex.optimised.DBLP2BibTeXRunner setOUT(java.lang.String modelOUTxmiFile, java.lang.String mmBTxmiFile){
...
return OUTModelResource;
	...
	public a2l.tests.dblp2bibtex.optimised.DBLP2BibTeXRunner run() throws java.lang.Exception{
a2l.tests.dblp2bibtex.optimised.DBLP2BibTeX trafo0;if ( this.stats == null ) this.stats = IStatsRecorder.NULL_RECORDER;;

	stats.startConfiguration();

	this.inputExtent = new InputExtent(); this.globalContext = new a2l.tests.dblp2bibtex.optimised.DBLP2BibTeXGlobalContext();this.INModel = this.INDataSource.createModel(this.globalContext::addAllInstancesObject, globalContext);inputExtent.addAll(this.INModel.allInstances());
inputExtent.shuffle();;
...
a2l.tests.dblp2bibtex.optimised.DBLP2BibTeX trafo = new a2l.tests.dblp2bibtex.optimised.DBLP2BibTeX(this.inputExtent, this.globalContext);
