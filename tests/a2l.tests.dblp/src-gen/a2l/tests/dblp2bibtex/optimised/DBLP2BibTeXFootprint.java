...
a2l.tests.dblp2bibtex.optimised.DBLP2BibTeXGlobalContext context = (a2l.tests.dblp2bibtex.optimised.DBLP2BibTeXGlobalContext) p_context;
	...
	if ( o instanceof dblp.DBLP.InCollection) {
return true;
}else if ( o instanceof dblp.DBLP.Book) {
return true;
...
Author c0;
java.lang.String get114;c0 = (dblp.DBLP.Author)o;

	/* 21:4-21:11: a2.name*/
	get114 = c0.getName();

	context.setValueOf_Author_name(get114);
}
return false;
}}}