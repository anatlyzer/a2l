...
import a2l.tests.dblp_v2.normal.DBLPv2GlobalContext;
...
public a2l.tests.dblp_v2.normal.DBLPv2Runner setNumThreads(int n){
numThreads = n;

	return this;
}
	public a2l.tests.dblp_v2.normal.DBLPv2Runner setFootprint(IFootprint n){
footprint = n;

	return this;
}
	public a2l.tests.dblp_v2.normal.DBLPv2Runner setStatsRecorder(IStatsRecorder n){
stats = n;

	return this;
}
	public a2l.tests.dblp_v2.normal.DBLPv2Runner doImmediateWrite(boolean n){
immediateWrite = n;

	return this;
}
	public a2l.tests.dblp_v2.normal.DBLPv2Runner setIN(org.eclipse.emf.ecore.resource.Resource modelINresource){
INDataSource = new lintra.emf.EMFDataSource(modelINresource, footprint);

	return this;
}
	public a2l.tests.dblp_v2.normal.DBLPv2Runner setIN(java.lang.String modelINxmiFile, java.lang.String mmMMxmiFile){
lintra.emf.LintraEMFUtils.ModelMetamodelPair m = lintra.emf.LintraEMFUtils.readModel(modelINxmiFile, mmMMxmiFile);return setIN(m.getModel());
	...
	public a2l.tests.dblp_v2.normal.DBLPv2Runner setOUT(org.eclipse.emf.ecore.resource.Resource modelOUTResource, org.eclipse.emf.ecore.resource.Resource mmMM1Resource){
OUTModelResource = modelOUTResource;
	...
	public a2l.tests.dblp_v2.normal.DBLPv2Runner setOUT(java.lang.String modelOUTxmiFile, java.lang.String mmMM1xmiFile){
...
return OUTModelResource;
	...
	public a2l.tests.dblp_v2.normal.DBLPv2Runner run() throws java.lang.Exception{
a2l.tests.dblp_v2.normal.DBLPv2 trafo0;if ( this.stats == null ) this.stats = IStatsRecorder.NULL_RECORDER;;

	stats.startConfiguration();

	this.inputExtent = new InputExtent(); this.globalContext = new a2l.tests.dblp_v2.normal.DBLPv2GlobalContext();this.INModel = this.INDataSource.createModel(this.globalContext::addAllInstancesObject, globalContext);inputExtent.addAll(this.INModel.allInstances());
inputExtent.shuffle();;
...
a2l.tests.dblp_v2.normal.DBLPv2 trafo = new a2l.tests.dblp_v2.normal.DBLPv2(this.inputExtent, this.globalContext);
