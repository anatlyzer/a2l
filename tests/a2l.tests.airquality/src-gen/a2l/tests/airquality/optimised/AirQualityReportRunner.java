...
a2l.tests.airquality.optimised.AirQualityReport trafo0;if ( this.stats == null ) this.stats = IStatsRecorder.NULL_RECORDER;;
	...
	this.inputExtent = new InputExtent(); this.globalContext = new a2l.tests.airquality.optimised.AirQualityReportGlobalContext();this.INModel = this.INDataSource.createModel(this.globalContext::addAllInstancesObject, globalContext);inputExtent.addAll(this.INModel.allInstances());
inputExtent.shuffle();;
