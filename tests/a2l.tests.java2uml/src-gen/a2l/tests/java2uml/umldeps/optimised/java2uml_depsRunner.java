...
immediateWrite = n;
	...
	public a2l.tests.java2uml.umldeps.optimised.java2uml_depsRunner setCM(org.eclipse.emf.ecore.resource.Resource modelCMresource){
CMDataSource = new lintra.emf.EMFDataSource(modelCMresource, footprint);

	return this;
}
	public a2l.tests.java2uml.umldeps.optimised.java2uml_depsRunner setCM(java.lang.String modelCMxmiFile, java.lang.String mmJMMxmiFile){
lintra.emf.LintraEMFUtils.ModelMetamodelPair m = lintra.emf.LintraEMFUtils.readModel(modelCMxmiFile, mmJMMxmiFile);return setCM(m.getModel());
	...
	public a2l.tests.java2uml.umldeps.optimised.java2uml_depsRunner setUCD(org.eclipse.emf.ecore.resource.Resource modelUCDResource, org.eclipse.emf.ecore.resource.Resource mmUMLMMResource){
UCDModelResource = modelUCDResource;
	...
	public a2l.tests.java2uml.umldeps.optimised.java2uml_depsRunner setUCD(java.lang.String modelUCDxmiFile, java.lang.String mmUMLMMxmiFile){
...
a2l.tests.java2uml.umldeps.optimised.java2uml_deps trafo0;if ( this.stats == null ) this.stats = IStatsRecorder.NULL_RECORDER;;
...
a2l.tests.java2uml.umldeps.optimised.java2uml_deps trafo = new a2l.tests.java2uml.umldeps.optimised.java2uml_deps(this.inputExtent, this.globalContext);
