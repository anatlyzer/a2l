...
public class java2uml_deps implements ITransformation, lintra2.transfo.ITransformation2 {
	...
	public Dependency lazy_rule_createGeneralizationDependency(ClassDeclaration class_) throws BlackboardException {
		...
		TypeAccess get167;
		Type get168;
		gTgt157 = org.eclipse.uml2.uml.UMLFactory.eINSTANCE.createDependency();
	...
	public Dependency lazy_rule_createUsageDependency(FieldDeclaration field) throws BlackboardException {
		...
		boolean op184;
		ClassDeclaration r185;
		gTgt169 = org.eclipse.uml2.uml.UMLFactory.eINSTANCE.createDependency();
		...
		for (ClassDeclaration cd181 : call182) {
			...
			get183 = cd181.getBodyDeclarations();
	...
	public javaslang.collection.List<ClassDeclaration> helper_org_eclipse_gmt_modisco_java_Package_allNonProxyClassesInPackage(
			org.eclipse.gmt.modisco.java.Package self_) throws BlackboardException {
	...
	public javaslang.collection.List<FieldDeclaration> helper_org_eclipse_gmt_modisco_java_ClassDeclaration_getRefClassFields(
			ClassDeclaration self_) throws BlackboardException {
	...
	public void create_Package2Package(org.eclipse.gmt.modisco.java.Package s1) throws BlackboardException {
		...
		/*
		 * null: s1.allNonProxyClassesInPackage->collect(s2 | if
		 * s2.getSuperClass.oclIsUndefined() then OclUndefined else
		 * thisModule.createGeneralizationDependency(s2) endif)
		 */
		...
		for (ClassDeclaration s2118 : call119) {
			/*
			 * 56:26-59:19: if s2.getSuperClass.oclIsUndefined() then OclUndefined else
			 * thisModule.createGeneralizationDependency(s2) endif
			 */
			...
			if (s2118 instanceof org.eclipse.gmt.modisco.java.ClassDeclaration) {
				call121 = helper_org_eclipse_gmt_modisco_java_ClassDeclaration_getSuperClass(
		...
		if (s1 instanceof org.eclipse.gmt.modisco.java.Package) {
			call128 = helper_org_eclipse_gmt_modisco_java_Package_allNonProxyClassesInPackage(
					(org.eclipse.gmt.modisco.java.Package) s1);
		} else {
			throw new IllegalStateException();
		}
		...
		for (ClassDeclaration s2127 : call128) {
			...
			if (s2127 instanceof org.eclipse.gmt.modisco.java.ClassDeclaration) {
				call129 = helper_org_eclipse_gmt_modisco_java_ClassDeclaration_getRefClassFields(
						(org.eclipse.gmt.modisco.java.ClassDeclaration) s2127);
			} else {
				throw new IllegalStateException();
			}
	...
	public void create_Class2Class(ClassDeclaration s1) throws BlackboardException {
		...
		boolean tmp151;
		boolean r152;
		t1143 = org.eclipse.uml2.uml.UMLFactory.eINSTANCE.createClass();
