...
public class java2uml_deps_mut implements ITransformation, lintra2.transfo.ITransformation2 {
	...
	public java2uml_deps_mut(a2l.runtime.InputExtent inputExtent,
	...
	public Dependency lazy_rule_createGeneralizationDependency(ClassDeclaration class_) {
		...
		List<java.lang.Object> itTmp181;
		gTgt166 = org.eclipse.uml2.uml.UMLFactory.eINSTANCE.createDependency();
	...
	public Dependency lazy_rule_createUsageDependency(FieldDeclaration field) {
		...
		List<java.lang.Object> itTmp201;
		gTgt182 = org.eclipse.uml2.uml.UMLFactory.eINSTANCE.createDependency();
		...
		for (ClassDeclaration cd195 : call196) {
			...
			get197 = new a2l.runtime.stdlib.FastIterableList<org.eclipse.gmt.modisco.java.BodyDeclaration>(
					cd195.getBodyDeclarations());
	...
	public javaslang.collection.List<FieldDeclaration> helper_org_eclipse_gmt_modisco_java_ClassDeclaration_getRefClassFields(
		...
		boolean op31;
		java.util.List<FieldDeclaration> r32;
		TypeAccess get33;
		Type get34;
		boolean get35;
		boolean tmp36;
		...
		//java.util.List<FieldDeclaration> r48;/*
		...
		//get30 = javaslang.collection.List
		//		.ofAll(new a2l.runtime.stdlib.FastIterableList<org.eclipse.gmt.modisco.java.BodyDeclaration>(
		//				self_.getBodyDeclarations()));

		// jesusc
		r32 = new ArrayList<FieldDeclaration>();//javaslang.collection.List.empty();

		//r48 = new ArrayList<FieldDeclaration>(); //javaslang.collection.List.empty();
		r48 = javaslang.collection.List.empty();
		
		for (BodyDeclaration e29 : new a2l.runtime.stdlib.FastIterableList<org.eclipse.gmt.modisco.java.BodyDeclaration>(self_.getBodyDeclarations())) {
			/* 29:41-29:76: e.oclIsTypeOf(JMM!FieldDeclaration) */
			op31 = e29 != null
					&& e29.eClass().getInstanceClass() == org.eclipse.gmt.modisco.java.FieldDeclaration.class;

			if (op31 == true) {
				FieldDeclaration e28 = (org.eclipse.gmt.modisco.java.FieldDeclaration) e29;
				...
				if (get38 instanceof org.eclipse.gmt.modisco.java.TypeAccess) {
					call39 = helper_org_eclipse_gmt_modisco_java_TypeAccess_isPrimitiveType(
							(org.eclipse.gmt.modisco.java.TypeAccess) get38);
				} else {
				...
				op45 = get44 != null
						&& get44.eClass().getInstanceClass() == org.eclipse.gmt.modisco.java.ClassDeclaration.class;
	...
	public a2l.tests.java2uml.umldeps.optimised.java2uml_deps_mut setCM(IModel n) {
		CMModel_ = n;

		return this;
	}

	public a2l.tests.java2uml.umldeps.optimised.java2uml_deps_mut setUCD(IOutputModel n) {
		UCDModel_ = n;
	...
	private void create_Model2Model(org.eclipse.gmt.modisco.java.Model s1) {
		...
		List<java.lang.Object> itTmp115;
		t1107 = org.eclipse.uml2.uml.UMLFactory.eINSTANCE.createModel();
	...
	private void create_Package2Package(org.eclipse.gmt.modisco.java.Package s1) {
		...
		java.util.Set<java.lang.Object> tgtElems151;
		t1116 = org.eclipse.uml2.uml.UMLFactory.eINSTANCE.createPackage();
		...
		if (s1 instanceof org.eclipse.gmt.modisco.java.Package) {
			call129 = helper_org_eclipse_gmt_modisco_java_Package_allNonProxyClassesInPackage(
					(org.eclipse.gmt.modisco.java.Package) s1);
		} else {
			throw new IllegalStateException();
		}
		...
		for (ClassDeclaration s2128 : call129) {
			...
			if (s2128 instanceof org.eclipse.gmt.modisco.java.ClassDeclaration) {
				call130 = helper_org_eclipse_gmt_modisco_java_ClassDeclaration_getSuperClass(
						(org.eclipse.gmt.modisco.java.ClassDeclaration) s2128);
			} else {
				throw new IllegalStateException();
			}
			op131 = call130 == null;
		...
		if (s1 instanceof org.eclipse.gmt.modisco.java.Package) {
			call137 = helper_org_eclipse_gmt_modisco_java_Package_allNonProxyClassesInPackage(
					(org.eclipse.gmt.modisco.java.Package) s1);
		} else {
			throw new IllegalStateException();
		}
		...
		for (ClassDeclaration s2136 : call137) {
			...
			if (s2136 instanceof org.eclipse.gmt.modisco.java.ClassDeclaration) {
				call138 = helper_org_eclipse_gmt_modisco_java_ClassDeclaration_getRefClassFields(
						(org.eclipse.gmt.modisco.java.ClassDeclaration) s2136);
			} else {
				throw new IllegalStateException();
			}
	...
	private void create_Class2Class(ClassDeclaration s1) {
		...
		boolean tmp160;
		boolean r161;
		t1152 = org.eclipse.uml2.uml.UMLFactory.eINSTANCE.createClass();
