...
private Cache<ClassDeclaration, java.util.List<BodyDeclaration>> cache15_cd;public java2uml_depsGlobalContext() {
cache15_cd = com.google.common.cache.CacheBuilder.newBuilder().concurrencyLevel(Runtime.getRuntime().availableProcessors()).<ClassDeclaration, java.util.List<BodyDeclaration>>build();
allInstancesCache = com.google.common.cache.CacheBuilder.newBuilder().concurrencyLevel(12).build();; }public java.util.List<BodyDeclaration> getcache15_cd(ClassDeclaration key, java.util.concurrent.Callable<java.util.List<BodyDeclaration>> closure) { try { return cache15_cd.get(key, closure); } catch (java.util.concurrent.ExecutionException e) { throw new IllegalStateException(); } }
