...
private Cache<ClassDeclaration, java.util.List<BodyDeclaration>> cache5_cd;public java2uml_depsGlobalContext() {
cache5_cd = com.google.common.cache.CacheBuilder.newBuilder().concurrencyLevel(Runtime.getRuntime().availableProcessors()).<ClassDeclaration, java.util.List<BodyDeclaration>>build();
allInstancesCache = com.google.common.cache.CacheBuilder.newBuilder().concurrencyLevel(12).build();; }public java.util.List<BodyDeclaration> getcache5_cd(ClassDeclaration key, java.util.concurrent.Callable<java.util.List<BodyDeclaration>> closure) { try { return cache5_cd.get(key, closure); } catch (java.util.concurrent.ExecutionException e) { throw new IllegalStateException(); } }
