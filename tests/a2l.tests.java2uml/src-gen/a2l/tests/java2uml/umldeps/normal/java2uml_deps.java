...
public class java2uml_deps implements ITransformation, lintra2.transfo.ITransformation2 {
	...
	public void create_Package2Package(org.eclipse.gmt.modisco.java.Package s1) throws BlackboardException {
		...
		/*
		 * 53:23-53:112: s1.ownedPackages->select(e | e.proxy = false)->select(e |
		...
		/*
		 * 55:23-59:20: s1.allNonProxyClassesInPackage->collect(s2 | if
		...
		/*
		 * 60:24-61:110: s1.allNonProxyClassesInPackage->collect(s2 |
		 * s2.getRefClassFields)->flatten()->collect(e |
		 * thisModule.createUsageDependency(e))
		 */
		/*
		 * 60:24-61:60: s1.allNonProxyClassesInPackage->collect(s2 |
		 * s2.getRefClassFields)->flatten()
		 */
		/*
		 * 60:24-61:47: s1.allNonProxyClassesInPackage->collect(s2 |
		 * s2.getRefClassFields)
		 */
