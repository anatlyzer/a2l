...
private IModel INModel_;
	...
	private PartialOutputModel OUTModel_PartialOutput_;a2l.runtime.InputExtent inputExtent;a2l.tests.findcouples.normal.FindCouplesIMDbGlobalContext globalContext;java.util.Map<Object, Object> trace = new java.util.HashMap<Object, Object>();public FindCouplesIMDb(a2l.runtime.InputExtent inputExtent,a2l.tests.findcouples.normal.FindCouplesIMDbGlobalContext global) {
...
this.parallelPendingTasks.add( new PendingTask_Couple_p1(c0,person1,OUTModel_) );
}
...
this.parallelPendingTasks.add( new PendingTask_Couple_p2(c0,person2,OUTModel_) );
}
...
List<java.lang.Object> itTmp21;m215 = imdb.movies.MoviesFactory.eINSTANCE.createMovie();
...
itTmp21.add(o);
	...
	this.pendingTasks.add( new PendingTask_Movie_persons(m215,itTmp21,OUTModel_) );
}
...
boolean tmp33;
Couple call34;
List<java.lang.Object> itTmp35;p222 = imdb.movies.MoviesFactory.eINSTANCE.createActor();
...
itTmp35.add(o);
	...
	this.pendingTasks.add( new PendingTask_Person_movies(p222,itTmp35,OUTModel_) );
...
boolean tmp47;
Couple call48;
List<java.lang.Object> itTmp49;p236 = imdb.movies.MoviesFactory.eINSTANCE.createActress();
...
itTmp49.add(o);
	...
	this.pendingTasks.add( new PendingTask_Person_movies(p236,itTmp49,OUTModel_) );
