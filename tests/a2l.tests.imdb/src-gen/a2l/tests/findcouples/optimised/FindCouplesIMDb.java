...
public class FindCouplesIMDb implements ITransformation, lintra2.transfo.ITransformation2 {
	...
	a2l.tests.findcouples.optimised.FindCouplesIMDbGlobalContext globalContext;
	a2l.runtime.GlobalTrace.PartialTrace trace = null;

	public FindCouplesIMDb(a2l.runtime.InputExtent inputExtent,
			a2l.tests.findcouples.optimised.FindCouplesIMDbGlobalContext global) {
	...
	public javaslang.collection.Set<Person> helper_global_coactor(Person p1) throws BlackboardException {
		...
		for (Movie m1 : get2) {
			get3 = this.globalContext.getcache2_m(m1, () -> {
	...
	public boolean helper_global_areCouple(Person p1, Person p2) throws BlackboardException {
		...
		boolean tmp11;/*
						 * 25:64-25:126:
						 * p1<NavRefAsSet>.movies->intersection(p2<NavRefAsSet>.movies)->size()
						 */
		...
		get7 = this.globalContext.getcache4_p2(p2, () -> {
	...
	public void create_movie(Movie m1) throws BlackboardException {
		...
		int get16;
		List<Person> get17;
		List<java.lang.Object> itTmp18;
		m212 = imdb.movies.MoviesFactory.eINSTANCE.createMovie();
	...
	public void create_actor(Actor p1) throws BlackboardException {
		...
		boolean tmp30;
		Couple call31;
		List<java.lang.Object> itTmp32;
		p219 = imdb.movies.MoviesFactory.eINSTANCE.createActor();
	...
	public void create_actress(Actress p1) throws BlackboardException {
		...
		boolean tmp44;
		Couple call45;
		List<java.lang.Object> itTmp46;
		p233 = imdb.movies.MoviesFactory.eINSTANCE.createActress();
