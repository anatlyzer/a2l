...
private IModel INModel_;
	...
	private PartialOutputModel OUTModel_PartialOutput_;a2l.runtime.InputExtent inputExtent;a2l.tests.findcouples.optimised.FindCouplesIMDbGlobalContext globalContext;java.util.Map<Object, Object> trace = new java.util.HashMap<Object, Object>();public FindCouplesIMDb(a2l.runtime.InputExtent inputExtent,a2l.tests.findcouples.optimised.FindCouplesIMDbGlobalContext global) {
...
itTmp18.add(o);
	...
	this.pendingTasks.add( new PendingTask_Movie_persons(m212,itTmp18,OUTModel_) );
}
...
itTmp32.add(o);
	...
	this.pendingTasks.add( new PendingTask_Person_movies(p219,itTmp32,OUTModel_) );
...
itTmp46.add(o);
	...
	this.pendingTasks.add( new PendingTask_Person_movies(p233,itTmp46,OUTModel_) );
