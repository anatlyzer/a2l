...
a2l.tests.imdb.identity.normal.IdentityIMDbGlobalContext context = (a2l.tests.imdb.identity.normal.IdentityIMDbGlobalContext) p_context;
	...
	return (o instanceof imdb.movies.Actress) || (o instanceof imdb.movies.Couple) || (o instanceof imdb.movies.Clique) || (o instanceof imdb.movies.Movie) || (o instanceof imdb.movies.Actor);
}}