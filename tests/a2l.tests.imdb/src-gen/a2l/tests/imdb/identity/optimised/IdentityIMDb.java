...
private IModel INModel_;
	...
	private PartialOutputModel OUTModel_PartialOutput_;a2l.runtime.InputExtent inputExtent;a2l.tests.imdb.identity.optimised.IdentityIMDbGlobalContext globalContext;
a2l.runtime.GlobalTrace.PartialTrace trace = null;
int numExecutions_ = 0;
int numMatchedRuleExecutions_ = 0;
public IdentityIMDb(a2l.runtime.InputExtent inputExtent,a2l.tests.imdb.identity.optimised.IdentityIMDbGlobalContext global) {
...
private static final class PendingTask_Group_commonMovies implements IPendingTask { 
private final imdb.movies.Group tgt;
private final Collection<Object> objId;
private final a2l.runtime.IModel area;
private final java.util.Set<? extends Object> tgtElems;
public PendingTask_Group_commonMovies(imdb.movies.Group tgt, Collection<Object> objId, a2l.runtime.IModel area, java.util.Set<? extends Object> tgtElems) {
	this.tgt = tgt; this.objId = objId; this.area = area; this.tgtElems = tgtElems;
}
public PendingTask_Group_commonMovies(imdb.movies.Group tgt, Object objId, a2l.runtime.IModel area, java.util.Set<? extends Object> tgtElems) {
	this.tgt = tgt; this.objId = java.util.Collections.singletonList(objId); this.area = area; this.tgtElems = tgtElems;
}
public void execute(a2l.runtime.GlobalTrace globalTrace) {
if (tgtElems == null) {ArrayList<Object> result = new ArrayList<>(objId.size());for (Object object : objId) {Object tgt = getTrace(object, globalTrace);  if (tgt instanceof imdb.movies.Movie) { result.add(tgt); }}
tgt.getCommonMovies().addAll((Collection<? extends imdb.movies.Movie>)result);}else {ArrayList<Object> result = new ArrayList<>(objId.size());for (Object object : objId) {  if (tgtElems.contains(object)) { result.add(getTargetResolveTempOrSame(object, globalTrace)); }  else {          Object tgt = getTrace(object, globalTrace);          if (tgt instanceof imdb.movies.Movie) { result.add(tgt); }   }}tgt.getCommonMovies().addAll((Collection<? extends imdb.movies.Movie>)result);} }
private final Object getTrace(Object object, a2l.runtime.GlobalTrace globalTrace) { return globalTrace.get(object);}
private final Object getTargetResolveTempOrSame(Object object, a2l.runtime.GlobalTrace globalTrace) {         if (object instanceof a2l.runtime.ResolveTempObject) {             a2l.runtime.ResolveTempObject rtmp = (a2l.runtime.ResolveTempObject) object;             return globalTrace.getSecondary(rtmp.getSource(), rtmp.getOpeName());         } return object;}
}

private static final class PendingTask_Clique_persons implements IPendingTask { 
private final imdb.movies.Clique tgt;
private final Collection<Object> objId;
private final a2l.runtime.IModel area;
private final java.util.Set<? extends Object> tgtElems;
public PendingTask_Clique_persons(imdb.movies.Clique tgt, Collection<Object> objId, a2l.runtime.IModel area, java.util.Set<? extends Object> tgtElems) {
	this.tgt = tgt; this.objId = objId; this.area = area; this.tgtElems = tgtElems;
}
public PendingTask_Clique_persons(imdb.movies.Clique tgt, Object objId, a2l.runtime.IModel area, java.util.Set<? extends Object> tgtElems) {
	this.tgt = tgt; this.objId = java.util.Collections.singletonList(objId); this.area = area; this.tgtElems = tgtElems;
}
public void execute(a2l.runtime.GlobalTrace globalTrace) {
if (tgtElems == null) {ArrayList<Object> result = new ArrayList<>(objId.size());for (Object object : objId) {Object tgt = getTrace(object, globalTrace);  if (tgt instanceof imdb.movies.Person) { result.add(tgt); }}
...
return p1 instanceof imdb.movies.Actress;
	...
	private boolean check_clique(java.lang.Object c1){
return c1 instanceof imdb.movies.Clique;
}
	private boolean check_couple(java.lang.Object c1){
...
throw new IllegalStateException();
	...
	public a2l.tests.imdb.identity.optimised.IdentityIMDb setIN(IModel n){
INModel_ = n;

	return this;
}
	public a2l.tests.imdb.identity.optimised.IdentityIMDb setOUT(IOutputModel n){
OUTModel_ = n;
...
int get4;
List<Person> get5;
List<java.lang.Object> itTmp6;m20 = imdb.movies.MoviesFactory.eINSTANCE.createMovie();
...
List<Movie> get9;
List<java.lang.Object> itTmp10;p27 = imdb.movies.MoviesFactory.eINSTANCE.createActor();
...
List<Movie> get13;
List<java.lang.Object> itTmp14;p211 = imdb.movies.MoviesFactory.eINSTANCE.createActress();
...
itTmp14.add(o);
	...
	private void create_clique(Clique c1){
Clique c215;
double get16;
List<Movie> get17;
List<Person> get18;
List<java.lang.Object> itTmp19;
List<java.lang.Object> itTmp20;c215 = imdb.movies.MoviesFactory.eINSTANCE.createClique();
...
itTmp20.add(o);
	...
	private void create_couple(Couple c1){
Couple c221;
double get22;
List<Movie> get23;
Person get24;
Person get25;
List<java.lang.Object> itTmp26;c221 = imdb.movies.MoviesFactory.eINSTANCE.createCouple();
...
boolean matched8 = false;if ( check_movie( e) )  {
