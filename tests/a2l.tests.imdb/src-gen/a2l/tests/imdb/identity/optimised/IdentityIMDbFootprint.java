...
a2l.tests.imdb.identity.optimised.IdentityIMDbGlobalContext context = (a2l.tests.imdb.identity.optimised.IdentityIMDbGlobalContext) p_context;
	...
	return (o instanceof imdb.movies.Couple) || (o instanceof imdb.movies.Movie) || (o instanceof imdb.movies.Actress) || (o instanceof imdb.movies.Clique) || (o instanceof imdb.movies.Actor);
}}