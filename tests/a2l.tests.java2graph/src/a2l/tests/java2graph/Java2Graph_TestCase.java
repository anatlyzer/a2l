...
public class Java2Graph_TestCase extends AbstractTestCase {
	...
	public static void main(String[] args) throws Exception {
		registerMetamodel(GraphMMPackage.eINSTANCE);

		Arguments arguments = parseArguments(args);
		new Java2Graph_TestCase().doBenchmark(arguments, trafo);		
	}
