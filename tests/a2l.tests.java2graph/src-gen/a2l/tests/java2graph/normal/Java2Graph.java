...
private IModel INModel_;
	...
	private PartialOutputModel OUTModel_PartialOutput_;a2l.runtime.InputExtent inputExtent;a2l.tests.java2graph.normal.Java2GraphGlobalContext globalContext;java.util.Map<Object, Object> trace = new java.util.HashMap<Object, Object>();public Java2Graph(a2l.runtime.InputExtent inputExtent,a2l.tests.java2graph.normal.Java2GraphGlobalContext global) {
...
this.parallelPendingTasks.add( new PendingTask_Edge_source(e44,get45,OUTModel_) );
}

	boolean matched1 = false;if ( check_toNode( get47) )  {
this.parallelPendingTasks.add( new PendingTask_Edge_target(e44,get47,OUTModel_) );
}
}
