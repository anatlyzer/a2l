...
import a2l.tests.java2graph.optimised.Java2GraphGlobalContext;
...
public a2l.tests.java2graph.optimised.Java2GraphRunner setNumThreads(int n){
numThreads = n;

	return this;
}
	public a2l.tests.java2graph.optimised.Java2GraphRunner setFootprint(IFootprint n){
footprint = n;

	return this;
}
	public a2l.tests.java2graph.optimised.Java2GraphRunner setStatsRecorder(IStatsRecorder n){
stats = n;

	return this;
}
	public a2l.tests.java2graph.optimised.Java2GraphRunner doImmediateWrite(boolean n){
immediateWrite = n;

	return this;
}
	public a2l.tests.java2graph.optimised.Java2GraphRunner setIN(org.eclipse.emf.ecore.resource.Resource modelINresource){
INDataSource = new lintra.emf.EMFDataSource(modelINresource, footprint);

	return this;
}
	public a2l.tests.java2graph.optimised.Java2GraphRunner setIN(java.lang.String modelINxmiFile, java.lang.String mmMMxmiFile){
lintra.emf.LintraEMFUtils.ModelMetamodelPair m = lintra.emf.LintraEMFUtils.readModel(modelINxmiFile, mmMMxmiFile);return setIN(m.getModel());
	...
	public a2l.tests.java2graph.optimised.Java2GraphRunner setOUT(org.eclipse.emf.ecore.resource.Resource modelOUTResource, org.eclipse.emf.ecore.resource.Resource mmMM1Resource){
OUTModelResource = modelOUTResource;
	...
	public a2l.tests.java2graph.optimised.Java2GraphRunner setOUT(java.lang.String modelOUTxmiFile, java.lang.String mmMM1xmiFile){
...
return OUTModelResource;
	...
	public a2l.tests.java2graph.optimised.Java2GraphRunner run() throws java.lang.Exception{
a2l.tests.java2graph.optimised.Java2Graph trafo0;if ( this.stats == null ) this.stats = IStatsRecorder.NULL_RECORDER;;
...
a2l.tests.java2graph.optimised.Java2Graph trafo = new a2l.tests.java2graph.optimised.Java2Graph(this.inputExtent, this.globalContext);
